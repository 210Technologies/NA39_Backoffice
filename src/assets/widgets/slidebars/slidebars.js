...
// 008 - User Input
    ...
    $.slidebars = function(options) {
        ...
        function eventHandler(event, selector) {
            ...
            if (event.type === 'click') selector.off('click'); // If event type was touch, turn off clicks to prevent phantom clicks.
        }

        // Toggle left Slidebar
        $(document).on(" touchend click", ".sb-toggle-left", function(event) {
          console.log(event)
